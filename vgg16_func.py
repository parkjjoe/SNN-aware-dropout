...
def VGG16(
    ...
    if conf.nn_mode=='ANN':
        ...
        #dropout_conv_r = [0.005, 0.005, 0.0]      # SNN training
    else:
        assert False
    ...
    # x = tf.keras.layers.Dens(100, activation=act_type, name='input_hidden')(x)
    # if conf.nn_mode=='SNN':
    #     x = tf.keras.layers.Dense(10, activation='act_type_out', name='hidden_output')(x)
    #
    # model = lib_snn.model.Model(img_input, x, 128, (28, 28), 10, conf, name=model_name)
